...
from realtime_anomaly_project.data_ingestion.yahoo import data_storage  # In-memory storage
...
def run_isolation_forest(ticker, data):
    ...
    # Return anomaly scores (1 = normal, -1 = anomaly)
    return preds
...
def compute_unsupervised_anomalies():
    ...
    # Print or return the unsupervised anomalies for further processing
