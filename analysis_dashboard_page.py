"""
Analysis Dashboard Page - Integrated with Real-Time Anomaly Detection System
This creates a new page/tab in your existing Streamlit application
"""
...
def load_analysis_data():
    ...
    try:
        data_dir = "comprehensive_analysis"
        
        # Load backtesting data
        backtesting_path = os.path.join(data_dir, "backtesting_results", "RELIANCE_NS_prediction_comparison_table.csv")
        ...
        # Load summary data
        summary_path = os.path.join(data_dir, "backtesting_results", "RELIANCE_NS_prediction_summary_stats.csv")
        ...
        # Load metrics data
        metrics_path = os.path.join(data_dir, "prediction_tables", "RELIANCE_NS_performance_metrics_table.csv")
